            ...
            <div className="rounded-2xl border border-emerald-500/20 bg-zinc-900/95 p-4 shadow-2xl backdrop-blur-xl">
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div className="min-w-0 flex-1 pr-6">
                        <h3 className="text-base font-semibold text-white">Nueva versión disponible</h3>
                        <p className="mt-1 text-sm text-zinc-400">Hay mejoras y correcciones disponibles.</p>
                    </div>
                </div>
