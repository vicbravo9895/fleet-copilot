...
<head>
  ...
  <title>Sin conexión - Fleet Copilot</title>
  <style>
...
<body>
  <div class="container">
    ...
    <p class="status">Fleet Copilot funciona mejor con conexión a internet</p>
  </div>
  <script>
...
self.addEventListener('push', (event) => {
  ...
  const options = {
    body: data.body || 'Nueva notificación de Fleet Copilot',
  ...
  event.waitUntil(
    self.registration.showNotification(data.title || 'Fleet Copilot', options)
  );
});
